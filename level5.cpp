...
int level5(int& sword, int& bow, int& armor, int& keys, int& killCount)
{
    ...
    char** arrMap = startGame("lvl5.txt", playerX, playerY);
    ...
    while (true)
    {
        ...
        case('C'):
        case('c'):
            if ((playerX == 2 && playerY == 2) || (playerX == 1 && playerY == 1) || (playerX == 1 && playerY == 3))
                chest51(bomb, bow);
            continue;
